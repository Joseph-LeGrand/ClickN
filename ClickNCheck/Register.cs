...
namespace ClickNCheck
{
    public static class Register
    {
        ...
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "post", Route ="api/DummyModels/users/register")]HttpRequestMessage req, TraceWriter log)
        {
